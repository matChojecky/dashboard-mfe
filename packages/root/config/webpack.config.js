...
module.exports = {
    ...
    output: {
        ...
        filename: isDevelopment ? 'static/js/[name].[contenthash:8].js' : 'static/js/[name].js',
        chunkFilename: isDevelopment ? 'static/js/[name].[contenthash:8].chunk.js' : 'static/js/[name].chunk.js',
        publicPath: paths.publicUrlOrPath,
        chunkLoadingGlobal: `webpackJsonp__${appPackageJson.name.replace('@', '').replace('/', '_')}`,
        globalObject: 'this',
